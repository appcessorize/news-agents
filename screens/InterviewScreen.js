...
const InterviewScreen = ({ isDemo, navigation }) => {
  const {
    errorMsg,
    loading,
  ...
  return (
    ...
    <View className="flex-1 bg-gray-50 p-4 flex items-center">
      ...
      <View className="w-full pb-4">
        <Text className="text-3xl font-bold mb-4 text-left">Interview</Text>
      ...
      <View className="w-full pb-4">
        <Text className="pb-2 text-lg leading-relaxed font-normal text-left ">
          This is where an AI journalist interviews you about your fiends
          stories. Your comment might make tomorrows AI generated news report
        </Text>
        ...
        <Text className="pb-4 text-lg leading-relaxed font-normal text-left ">
          To try it out comment on the tomorrows weather
        </Text>
      </View>
      <View>
        <Text className="pb-2 text-lg leading-relaxed font-normal text-left  ">
          How would you like to interviewed?
        </Text>
        <View className="flex ">
          <Pressable
            className=" bg-red-500 hover:bg-red-700 text-white font-bold py-4 mb-4 rounded flex items-center justify-center flex-row"
          ...
          <Pressable
            className=" bg-red-500 hover:bg-red-700 text-white font-bold py-4 mb4 rounded flex items-center justify-center flex-row"
            onPress={() => console.log("pressed")}
          >
            <Text className="text-xl font-bold text-white mr-1">
              Video Comment
